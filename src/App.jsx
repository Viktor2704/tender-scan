...
function createDemoTenders() {
  return [
    ...
    { id: "bz-004", number: "BZ-2026-4756", title: "Монтаж СКУД на 3 объектах", platform: "bidzaar", company: "ФГУП «Охрана» Росгвардии", region: "Москва", price: 3400000, deadline: "2026-03-22", published: "2026-03-05", eval: "recommend", status: "ending", participants: 7, notes: "Турникеты + считыватели + контроллеры. Короткий срок.", docs: [] },
    ...
    { id: "b2b-001", number: "B2B-887432", title: "Установка видеонаблюдения склад", platform: "b2b", company: "ООО «Вайлдберриз»", region: "Москва", price: 1750000, deadline: "2026-03-30", published: "2026-03-09", eval: "check", status: "active", participants: 4, notes: "Нужно уточнить точный адрес и количество камер.", docs: ["Запрос.pdf"] },
